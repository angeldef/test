...
export function ModalConfig({ open, onClose, negotiatorFormalization }: Props) {
  const { service, contractDateStart, contractDateEnd, descService, annexDateStart, annexDateEnd, quantity, frequencyDescription, currency } =
