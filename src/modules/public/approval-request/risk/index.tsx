...
export const ApprovalRequestRisk = () => {
  ...
  const onLoad = async () => {
    if (id && token) {
      ...
      if (resp) {
        const { negotiation, supplier, quotation, negotiator, risk } = resp.data as RespGetNegociationInfoByTokenType;
        setNegotiation(negotiation);
        setSupplier(supplier);
        setQuotation(quotation ? quotation[0] : undefined);
        setNegotiator(negotiator);
        if (risk.approvedByRisk || risk.reasonRejection) setMessage('TU RESPUESTA YA FUE ENVIADA AL NEGOCIADOR.');
      }
    }
  };
          ...
          <div className='main'>
            <div className={styles.row}>
              <div className={styles.left}>
                <h1>Solicitud de Aprobación de Riesgos</h1>
        ...
        >
          ...
          <DialogContent>
            {action == 'accept' && (
              <div className={`${styles.modalBody} text-center`}>
                <div className={`${styles.titleSecondary} joey`}>
                  Confirmación <br /> de Gestión de Riesgos
                </div>

                <p className={styles.bold}>La confirmación de Línea de Riesgo está a punto de ser aceptada.</p>
            ...
            {action == 'reject' && (
              <div className={`${styles.modalBody} text-center`}>
                <div className={`${styles.titleSecondary} joey`}>
                  Confirmación de Rechazo <br /> de Gestión de Riesgos
                </div>

                <p className={styles.bold}>La confirmación de Línea de Riesgo está a punto de ser rechazada.</p>
